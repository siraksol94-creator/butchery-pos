...
import { FiPlus, FiTrash2, FiX, FiEye, FiTool, FiAlertTriangle } from 'react-icons/fi';
        ...
        <table className="data-table">
          ...
          <tbody>
            {loading ? (
              ...
              <tr><td colSpan={8} style={{ textAlign: 'center', padding: 32, color: '#9ca3af' }}>No production entries yet.</td></tr>
            ) : entries.map(e => (
              <tr key={e.id}>
